...
contract Constants {
    ...
    uint internal constant Q112 = 0x10000000000000000000000000000; // 2**112
    uint internal constant Q224 = 0x100000000000000000000000000000000000000000000000000000000; // 2**224
